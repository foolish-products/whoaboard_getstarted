...
#define sortedRaw_slackToDecrease -5
...
void loop() {
  ...
  // This will output a "smoothed" signal which is easier to work with (this will prob dissapear) 
  processSense(rawSenseResults);
